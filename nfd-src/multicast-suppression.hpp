...
public:
  ...
  void
  addUpdateEMA(int duplicateCount, bool wasForwarded, std::string name, std::string segment);
  ...
  void
  updateDelayTime(bool wasForwarded, std::string name, std::string segment);
