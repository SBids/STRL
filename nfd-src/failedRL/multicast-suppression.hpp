...
public:
  ...
  void addUpdateEMA(int duplicateCount, bool wasForwarded, std::string name, std::string seg_name, char type, time::milliseconds waitTime, NameTree* nameTree);
  ...
  void
  // updateDelayTime(std::string name, std::string seg_name, float duplicateCount, time::milliseconds suppression_time, bool wasForwarded, char type, NameTree* nameTree);
  updateDelayTime(std::string name, std::string seg_name, float duplicateCount, time::milliseconds suppression_time, bool wasForwarded, char type, NameTree* nameTree);
...
void
updateMeasurement(Name name, char type, time::milliseconds waitTime, std::string isDropped);

// set interest or data expiration
void
setUpdateExpiration(time::milliseconds entryLifetime, Name name, char type, time::milliseconds waitTime, bool isForwarded);
